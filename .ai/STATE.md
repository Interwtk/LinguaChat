...
Updated after completion of the A1–C2 Curriculum Foundry, final supervisor acceptance and release-candidate hardening on 2026-08-23.
...
`LC-PED-002` is now the first claimable serial task. Its previous blocker (“A1 arcs 6 and 7 implemented”) is satisfied.

It must re-prove the final integrated Pre-A1 + A1 learning journey before any A1 availability decision:
...
A1 MUST remain `available:false` throughout this gate.
