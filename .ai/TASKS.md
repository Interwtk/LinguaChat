...
- [LC-PROD-002] Explicit A1 availability decision gate
  ...
  why:    LC-PED-002 proved the final Pre-A1+A1 learning gate and LC-I18N-006 has now
          honestly localized A1 arcs 6–7's auxiliary copy, but neither is itself
          authorization to expose A1 to learners.
