  ...
  async function submitFree(evalKind, itemIds, { fromSuggestion } = {}) {
    ...
    try {
      result = await evaluateEpisodeResponse({
        ...
        spanTurns: spanTurns.length ? spanTurns : undefined,
