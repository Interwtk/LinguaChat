...
const base = {
  ...
  quickAccess: "At hand",
  quickSessionHint: "Pick up where you left off.",
  quickPracticeHint: "Talk freely with Lingua.",
  quickWordsHint: "Words that have come up with you.",
  quickArchiveHint: "Go back to earlier conversations.",
  quickNotesHint: "Corrections worth seeing again.",
  yourPath: "Your path",
