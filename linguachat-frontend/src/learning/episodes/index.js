...
const GREETINGS_01 = {
  ...
  steps: [
    ...
    { type: 'free_reply', variation: true, sceneEn: 'Hello! I’m Alex.', instructionKey: 'ep1VariationInstruction',
...
const GREETINGS_02 = {
  ...
  steps: [
    ...
    { type: 'model', target: 'What’s your name?', response: 'I’m Alex.', meaningItems: ['whats_your_name', 'im'], explainKey: 'ep2ModelExplain' },
    ...
    { type: 'free_reply', speaker: 'lingua', promptEn: 'I’m Alex.', instructionKey: 'ep2AskInstruction',
...
const GREETINGS_03 = {
  ...
  steps: [
    ...
    { type: 'free_reply', speaker: 'lingua', promptEn: 'Hi! I’m Alex. What’s your name?', instructionKey: 'ep3RoleplayIntro',
      evalKind: 'introduction', suggestionEn: 'Hi, I’m {name}.', itemIds: ['hi', 'im'] },
