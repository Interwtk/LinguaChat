...
const B1_EP1 = {
  ...
  xp: 120,
  prerequisites: [
    'one_thing_after_another', 'when_it_happened', 'what_i_think',
    'agree_to_disagree', 'changing_the_subject', 'tell_me_more',
  ],
  skillPrerequisites: [],
  gardenItems: [],
  reuseSkills: [
...
const B1_EP2 = {
  ...
  xp: 130,
  prerequisites: [
    'more_than_two', 'the_trip_i_took',
    'whats_the_plan', 'someday',
    'somethings_not_right', 'lets_sort_this_out',
  ],
  skillPrerequisites: [],
  gardenItems: [],
  reuseSkills: [
